...
# 使用gpt标注数据
def first_annotate(dir_path, file_name):
    filepath = os.path.join(dir_path, file_name)
    dialogues = split_dialogue(filepath)
...
def process_one_file(dir_path, file_name, rsp):
    # 处理单个文件
    filepath = os.path.join(dir_path, file_name)
    # split
    dialogues = split_dialogue(filepath)
...
if __name__ == '__main__':
    # 文件路径
    dir_path = r'C:\Users\ASUS\PycharmProjects\mental_template\data\process_CBT\APA_CBT'
